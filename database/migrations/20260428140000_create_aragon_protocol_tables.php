...
class Migration_20260428140000_create_aragon_protocol_tables {
    private \PDO $db;
    ...
    public function up(): void {
        ...
        $this->db->exec("CREATE INDEX idx_aragon_case_report ON aragon_protocol_cases(report_id)");
        $this->db->exec("CREATE INDEX idx_aragon_annex_case ON aragon_protocol_annexes(protocol_case_id)");
    }
