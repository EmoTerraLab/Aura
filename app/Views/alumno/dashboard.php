    ...
    <div class="px-4 py-8 md:px-margin-page md:py-12 max-w-6xl mx-auto w-full flex-1 flex flex-col gap-stack-gap">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-gutter items-start">
            ...
            <div id="main-view-container" class="lg:col-span-8 flex flex-col gap-6">
                ...
                <div id="home-view" class="animate-fadeIn space-y-6">
                    ...
                    <div class="bg-primary-container bg-gradient-to-br from-primary to-primary-fixed text-on-primary p-8 md:p-10 rounded-3xl shadow-xl shadow-primary/20 relative overflow-hidden group">
                        ...
                        <div class="relative z-10">
                            <span class="material-symbols-outlined text-5xl opacity-30 mb-4 block">format_quote</span>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-secondary-container p-6 rounded-3xl shadow-sm border border-secondary/10 flex flex-col justify-between group">
                            ...
                            <button id="btn-start-report" class="bg-white text-secondary px-6 py-3 rounded-full font-bold text-sm shadow-md hover:scale-[1.03] transition-all flex items-center justify-center gap-2 group-hover:bg-secondary group-hover:text-white">
                ...
                <div id="main-wizard-container" class="hidden bg-surface-container-lowest rounded-xl shadow-[0_8px_40px_rgba(0,79,86,0.04)] p-4 md:p-card-padding flex flex-col relative overflow-hidden min-h-[500px] animate-fadeIn">
...
<script>
    ...
    // --- Gestión de Vistas ---
    const ViewManager = {
        views: ['home-view', 'main-wizard-container', 'chat-view', 'wizard-success'],
        ...
        showReporting() {
            this.hideAll();
            document.getElementById('main-wizard-container').classList.remove('hidden');
    ...
    function initHomeData() {
        const quotes = [
            ...
            {"text": "\"Tus emociones son válidas. Tómate el tiempo que necesites para sentirlas.\"", "author": "Anónimo"},
            {"text": "\"No tienes que ser perfecto para ser increíble.\"", "author": "Anónimo"}
        ];

        const curiosities = [
            "¿Sabías que... tomar pequeños descansos de 5 minutos por cada 25 minutos de estudio (Técnica Pomodoro) ayuda a evitar la fatiga mental y mejora tu memoria?",
            "¿Sabías que... escribir cómo te sientes en un papel puede reducir significativamente el estrés y la ansiedad?",
            "¿Sabías que... respirar profundamente tres veces seguidas le envía una señal fisiológica a tu cerebro para que se relaje casi al instante?",
            "¿Sabías que... ayudar a un compañero segrega oxitocina, la hormona de la felicidad, tanto en ti como en quien recibe la ayuda?",
            "¿Sabías que... escuchar música sin letra mientras estudias mejora tu capacidad de concentración?"
        ];
