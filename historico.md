...
- **Interfaz Móvil:** Rediseño del menú lateral responsivo para una mejor experiencia en Safari (iOS) con soporte para botón hamburguesa y capa de fondo.
...
- **XSS Hardening:** Aplicación sistemática de `escapeHtml()` en todos los dashboards para sanitizar el contenido renderizado mediante JavaScript.
- **Restauración de Protecciones:** Recuperación de validaciones CSRF y protecciones contra Path Traversal en los flujos de protocolos autonómicos.
...
### 🛡️ Seguridad y Estabilidad
- **Limpieza de Marca:** Eliminación definitiva de todas las referencias "PDP" en el código fuente, base de datos y comunicaciones por email para consolidar la versión de producción.
